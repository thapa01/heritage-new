    ...
    <main className="min-h-screen bg-[#f7f3ea] text-[#211f1b]">
      <section className="relative overflow-hidden px-5 pb-10 pt-28 sm:px-6 sm:pb-12 sm:pt-32 md:px-10 md:pb-16 md:pt-36 lg:px-16">
        <div
          ...
          style={{
            backgroundImage: `
              radial-gradient(circle at 15% 20%, rgba(177,145,88,0.10), transparent 28%),
              radial-gradient(circle at 85% 10%, rgba(177,145,88,0.08), transparent 25%),
              linear-gradient(rgba(120,100,70,0.025) 1px, transparent 1px),
              linear-gradient(90deg, rgba(120,100,70,0.025) 1px, transparent 1px)
            `,
        ...
        <div className="relative mx-auto max-w-[1500px]">
          ...
          >
            ...
            <br />
            <span className="text-[#a18758]">beautifully remembered.</span>
          </motion.h1>
          ...
          >
            Explore celebrations, gatherings and memorable moments captured at
            Boudha Heritage.
          </motion.p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1500px]">
          <div className="mb-7 flex items-end justify-between border-b border-[#211f1b]/10 pb-4">
            <div>
              ...
              <h2 className="font-serif text-3xl md:text-4xl">Videos</h2>
            </div>
          ...
          {videos.length === 0 ? (
            <p className="py-6 text-sm text-[#211f1b]/50">No videos yet.</p>
          ) : (
      ...
      <section className="border-t border-[#211f1b]/10 px-5 py-16 sm:px-6 sm:py-20 md:px-10 lg:px-16">
        <div className="mx-auto max-w-[1500px]">
          ...
          {photos.length === 0 ? (
            <p className="py-6 text-sm text-[#211f1b]/50">No photos yet.</p>
          ) : (
              ...
              {photos.map((photo, index) => (
                ...
                >
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    <img
                      src={photo.src}
                      alt={photo.title ?? "Boudha Heritage"}
      ...
      <section className="px-5 pb-16 pt-2 text-center sm:px-6 sm:pb-20 md:px-10 lg:px-16">
        <div className="mx-auto max-w-2xl border-t border-[#211f1b]/10 pt-10 sm:pt-12">
          ...
          <h2 className="mt-4 font-serif text-xl leading-tight text-[#211f1b]/75 sm:text-2xl md:text-3xl">
            ...
            <br />
            <span className="text-[#a18758]">to be remembered.</span>
          </h2>
        </div>
      </section>
    </main>

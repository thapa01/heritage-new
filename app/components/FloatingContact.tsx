...
export default function FloatingContact() {
  ...
  return (
    <div className="fixed bottom-4 right-3 z-[60] flex flex-col gap-2.5 sm:bottom-5 sm:right-4 sm:gap-3 md:bottom-7 md:right-7">
      ...
      >
        ...
        <span className="flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_30px_rgba(37,211,102,0.30)] transition duration-300 group-hover:shadow-[0_14px_35px_rgba(37,211,102,0.40)] sm:h-14 sm:w-14 md:h-16 md:w-16">
      ...
      >
        ...
        <span className="flex h-12 w-12 items-center justify-center rounded-full bg-[#302b25] text-white shadow-[0_10px_30px_rgba(48,43,37,0.25)] transition duration-300 group-hover:bg-[#b89455] sm:h-14 sm:w-14 md:h-16 md:w-16">

          <svg
            viewBox="0 0 24 24"
            className="h-5 w-5 fill-none stroke-current stroke-[1.8] sm:h-6 sm:w-6 md:h-7 md:w-7"
            aria-hidden="true"
          >
            <path
              strokeLinecap="round"
